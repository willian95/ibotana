...
export class AppComponent {
  ...
  a2 = [
    { name: 'Inicio', icon: 'home', url: 'home', img: 'assets/left-menu-icon/home.png' },
    { name: 'Categorias', icon: 'apps', url: 'categories', img: 'assets/left-menu-icon/category.png' },
    {
      name: 'Tienda', icon: 'cash', url: '/products', img: 'assets/left-menu-icon/shop.png',
      items: [
        { name: "Nuevos", url: '/products/0/0/newest' },
        { name: "En Venta", url: '/products/0/0/sale' },
        { name: "Destacados", url: '/products/0/0/featured' },
      ],
      expanded: false
    }];
  a3 = [
    { name: 'Favoritos', icon: 'heart', img: 'assets/left-menu-icon/wishlist.png', url: '/wish-list', value: 'wishListPage' },
  ...
  openCategoryPage() {
    this.router.navigateByUrl("categories/0/0")
